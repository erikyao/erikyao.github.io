...
$$ U = \begin{vmatrix}  \vert  &  \vert  &  &  \vert  \\ u^{(1)} & u^{(2)} & ... & u^{(n)} \\  \vert  &  \vert  &  &  \vert  \end{vmatrix} $$ (size=nxn)
...
$$ U_{reduce} = \begin{vmatrix}  \vert  &  \vert  &  &  \vert  \\ u^{(1)} & u^{(2)} & ... & u^{(k)} \\  \vert  &  \vert  &  &  \vert  \end{vmatrix} $$ (size=nxk)

...
The law of large numbers states that if $X_1,\ldots X_n$ are i.i.d. from a population with mean $\mu$ and variance $\sigma^2$, then $\overline{X}$, the sample average of the _**n**_ observations, converges in probability to $\mu$, i.e. 

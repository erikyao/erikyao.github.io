---
layout: post
title: "Terminology Recap: Sampling / Sample / Sample Space / Experiment / Statistical Model / Statistic / Estimator / Empirical Distribution / Likelihood / Estimation and Machine Learning"
description: ""
category: Math
tags: []
---
...
## 8. The Likelihood Function / Sufficient Statistics
...
### 8.3 The likelihood Function is a Minimal Sufficient Statistic
...
## 9. Estimation/Estimators used in Machine Learning
...
1. MLE, Maximum Likelihood Estimation
    ...
    - Example: Linear Regression, Logistic Regression, Linear Discriminant Analysis
1. Bayersian Estimation
1. MAP, Maximum A _Posteriori_ (Estimation)
...
$$
\begin{aligned} 
\theta_{\text{ML}} &= \underset{\theta}{\arg \max } \, \mathbb{P}_{\text{model}}(\mathbb{X}; \theta) \newline
...
其实 linear regression 并没有说需要 assumption on Gaussian distributions，但是你会注意到我们 linear regression 一般是 minimizing $\operatorname{MSE}$，联系我们之前说到的 "$\operatorname{MSE}$ is the cross-entropy between the empirical distribution and a Gaussian model"，那么 linear regression 中到底哪里出现了 Gaussian model 呢？

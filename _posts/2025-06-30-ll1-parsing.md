...
- $\operatorname{FOLLOW}(A \in V) = \lbrace x \in \Sigma \mid x \text{ is the first terminal that follows } A \text{ in a sentential form} \text{. I.e. } S \overset{\ast}{\Rightarrow} Ax \dots\rbrace$

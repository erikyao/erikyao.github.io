...
See [LL(1) Parser Visualization, by Zak Kincaid and Shaowei Zhu](https://www.cs.princeton.edu/courses/archive/spring20/cos320/LL1/).
...
|Variable|$\operatorname{FIRST}$ |$\operatorname{FOLLOW}$|
|--------|-----------------------|-----------------------|
|$S$     | $\lbrace ( , \text{id} \rbrace$|                       |
|$E$     | $\lbrace ( , \text{id} \rbrace $| $\lbrace ), \Finv \rbrace$|
|$E'$    | $\lbrace + , \varepsilon \rbrace$| $\lbrace ), \Finv \rbrace$|
|$T$     | $\lbrace ( , \text{id} \rbrace$| $\lbrace +, ), \Finv \rbrace$|
|$T'$    | $\lbrace \ast, \varepsilon \rbrace$| $\lbrace +, ), \Finv \rbrace$|
|$F$     | $\lbrace (, \text{id} \rbrace$| $\lbrace +, \ast, ), \Finv \rbrace$|

| Variable / Terminal | $\Finv$              | $+$                  | $\ast$            | $($         | $)$                  | $\text{id}$ |
|:-------------------:|:--------------------:|:--------------------:|:-----------------:|:-----------:|:--------------------:|:-----------:|
| $S$  |                      |                      |                   | $S \to E$   |                      | $S \to E$   |
| $E$  |                      |                      |                   | $E \to TE'$ |                      | $E \to TE'$ |
| $E'$ | $E' \to \varepsilon$ | $E' \to + T E'$      |                   |             | $E' \to \varepsilon$ |             |
| $T$  |                      |                      |                   | $T \to FT'$ |                      | $T \to FT'$ |
| $T'$ | $T' \to \varepsilon$ | $T' \to \varepsilon$ | $T' \to \ast F T'$|             | $T' \to \varepsilon$ |             |
| $F$  |                      |                      |                   | $F \to (E)$ |                      | $F \to id$  |
